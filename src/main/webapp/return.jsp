...
<html lang="en">
  <head>
    ...
    <title>Return Flight Available</title>
 ...
 <%
  	...
  	if ("Economy Class".equals(flightclass)) {
        ...
        for (int i = 0; i < 4; i++) {
        	flight1_price = rand.nextInt(40001) + 40000; // Generate random number between 20000 and 60000
        	flight2_price = rand.nextInt(40001) + 40000; // Generate random number between 20000 and 60000
        	flight3_price = rand.nextInt(40001) + 40000;
        	flight4_price = rand.nextInt(40001) + 40000;
        }
    	...
    	Random rand = new Random();
        for (int i = 0; i < 4; i++) {
        	flight1_price = rand.nextInt(40001) + 135000; // Generate random number between 20000 and 60000
        	flight2_price = rand.nextInt(40001) + 135000; // Generate random number between 20000 and 60000
        	flight3_price = rand.nextInt(40001) + 135000;
        	flight4_price = rand.nextInt(40001) + 135000;
        }
    ...
    for (int i = 0; i < 6; i++) {
        ...
        switch (i) {
            ...
            case 3:
                ...
                break;
            case 4:
                futureTime5 = formattedTime;
                break;
            case 5:
            	futureTime6 = formattedTime;
            	break;
        }
    }
                            ...
                            <div class="card">
                                ...
                                <div class="pt-2">
                                    <div class="d-md-flex flex-row justify-content-evenly">
                                        <h5 class="card-text fw-bold">Departure:-<span class="fw-bold font5 fs-3 fontcolor"><%=Rfrom %></span></h4>
                                        <i class="fas fa-plane-departure"></i>
                                        <h5 class="card-text fw-bold">Arrival:-<span class="fw-bold font5  fs-3 fontcolor"><%=Rto %></span></h5>
                                    </div>
                                    <div class="text-start d-md-flex flex-row justify-content-evenly">
                                            ...
                                            <p>On Date:-<span class="fw-bold fontcolor2"><%=Departuredate %> </span></p>    
                                            <p>Flight ID:- <span class="fw-bold fontcolor2"> <%=Id1 %></p>
                                    </div>
                                </div>
                                <div class="py-3">
                                    <div class="d-md-flex flex-row justify-content-evenly">
                                        <h5 class="card-text fw-bold">Departure:-<span class="fw-bold font5 fs-3 fontcolor"><%=Rto %></span></h4>
                                        <i class="fas fa-plane-departure"></i>
                                        <h5 class="card-text fw-bold">Arrival:-<span class="fw-bold font5 fs-3 fontcolor"><%=Rfrom %></span></h5>
                                    </div>
                                    <div class="text-start d-md-flex flex-row justify-content-evenly">
                                        <p>Flight Timing:-<span class="fw-bold fontcolor2"> <%= futureTime2 %> </span></p>
                                        <p>On Date:-<span class="fw-bold fontcolor2"><%= Returndate%></span></p>    
                                        <p>Flight ID:- <span class="fw-bold fontcolor2"> <%=Id1 %></p>
                                    </div>
                                </div>
                                <div class="text-start d-md-flex flex-row justify-content-between px-5">
                                ...
                                <div class="text-center">
                                    <form action="returnflightvalues" method="post">
									    <input type="hidden" name="flightId" value="<%= Id1 %>">
									    <input type="hidden" name="price" value="<%= flight1_price %>">
									    <input type="hidden" name="time1" value="<%= futureTime1 %>">
									    <input type="hidden" name="time2" value="<%= futureTime2 %>">
                            ...
                            <div class="card">
                                ...
                                <div class="pt-2">
                                    <div class="d-md-flex flex-row justify-content-evenly">
                                        <h5 class="card-text fw-bold">Departure:-<span class="fw-bold font5 fs-3 fontcolor"><%=Rfrom %></span></h4>
                                        <i class="fas fa-plane-departure"></i>
                                        <h5 class="card-text fw-bold">Arrival:-<span class="fw-bold fs-3 font5 fontcolor"><%=Rto %></span></h5>
                                    </div>
                                    <div class="text-start d-md-flex flex-row justify-content-evenly">
                                            <p>Flight Timing:-<span class="fw-bold fontcolor2"> <%= futureTime3%> </span></p>
                                            <p>On Date:-<span class="fw-bold fontcolor2"><%=Departuredate %> </span></p>    
                                            <p>Flight ID:- <span class="fw-bold fontcolor2"> <%=Id2 %></p>
                                    </div>
                                </div>
                                <div class="py-3">
                                    <div class="d-md-flex flex-row justify-content-evenly">
                               ...
                               <div class="text-center">
                                    <form action="returnflightvalues" method="post">
									    <input type="hidden" name="flightId" value="<%= Id2 %>">
									    <input type="hidden" name="price" value="<%= flight2_price %>">
									    <input type="hidden" name="time1" value="<%= futureTime3 %>">
									    <input type="hidden" name="time2" value="<%= futureTime4 %>">
									    <button type="submit" class="btn btn-primary">BOOK NOW</button>
									</form>
                                </div>
                            </div>
                        ...
                        <div class="col-12 p-0 my-3">
                            <div class="card">
                                ...
                                <div class="pt-2">
                                    ...
                                    <div class="text-start d-md-flex flex-row justify-content-evenly">
                                            <p>Flight Timing:-<span class="fw-bold fontcolor2"> <%= futureTime5 %> </span></p>
                                            <p>On Date:-<span class="fw-bold fontcolor2"><%=Departuredate %> </span></p>    
                                            <p>Flight ID:- <span class="fw-bold fontcolor2"> <%=Id3 %></p>
                                    </div>
                                </div>
                                <div class="py-3">
                                    <div class="d-md-flex flex-row justify-content-evenly">
                                        <h5 class="card-text fw-bold">Departure:-<span class="fw-bold fs-3 font5  fontcolor"><%=Rto %></span></h4>
                                        <i class="fas fa-plane-departure"></i>
                                        <h5 class="card-text fw-bold">Arrival:-<span class="fw-bold fs-3 font5  fontcolor"><%=Rfrom %></span></h5>
                                    </div>
                                    <div class="text-start d-md-flex flex-row justify-content-evenly">
                                        <p>Flight Timing:-<span class="fw-bold fontcolor2"> <%= futureTime6 %> </span></p>
                                        <p>On Date:-<span class="fw-bold fontcolor2"><%= Returndate%></span></p>    
                                        <p>Flight ID:- <span class="fw-bold fontcolor2"> <%=Id3 %></p>
                                    </div>
                                </div>
                                <div class="text-start d-md-flex flex-row justify-content-between px-5">
                                    <h6>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype%></h6>
                                    <h6>Flight Class:- <span class="fw-bold fontcolor2"><%= flightclass %> </span></hh6>
                                    <h6>Price:-<span class="fw-bold fontcolor2"><%= flight3_price %>/-</h6>
                                </div>
								<div class="text-center">
                                    <form action="returnflightvalues" method="post">
									    <input type="hidden" name="flightId" value="<%= Id3 %>">
									    <input type="hidden" name="price" value="<%= flight3_price %>">
									    <input type="hidden" name="time1" value="<%= futureTime5 %>">
									    <input type="hidden" name="time2" value="<%= futureTime6 %>">
									    <button type="submit" class="btn btn-primary">BOOK NOW</button>
									</form>
                                </div>
                            </div>
