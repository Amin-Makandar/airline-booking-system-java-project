...
<html lang="en">
  ...
  <%
  	...
  	if ("Economy Class".equals(flightclass)) {
        ...
        for (int i = 0; i < 4; i++) {
        	flight1_price = rand.nextInt(30001) + 20000; // Generate random number between 20000 and 50000
        	flight2_price = rand.nextInt(30001) + 20000; // Generate random number between 20000 and 50000
        	flight3_price = rand.nextInt(30001) + 20000;
        	flight4_price = rand.nextInt(30001) + 20000;
        }
    	 ...
    	 Random rand = new Random();
         for (int i = 0; i < 4; i++) {
        	 flight1_price = rand.nextInt(25000) + 75000; // Generate random number between 75000 and 100000
         	flight2_price = rand.nextInt(25000) + 75000; // Generate random number between 75000 and 100000
         	flight3_price = rand.nextInt(25000) + 75000;
        	flight4_price = rand.nextInt(25000) + 75000;
         }
    	...
    	Random rand = new Random();
        for (int i = 0; i < 4; i++) {
        	flight1_price = rand.nextInt(70001) + 80000; // Generate random number between 20000 and 60000
        	flight2_price = rand.nextInt(70001) + 80000; // Generate random number between 20000 and 60000
        	flight3_price = rand.nextInt(70001) + 80000;
        	flight4_price = rand.nextInt(70001) + 80000;
        }
                                ...
                                <div class="card-body text-white font7">
                                	<h6 class="card-title text-center font2">Flight 1</h6>
                                		<div class="d-md-flex flex-row justify-content-evenly text-center">
                                			<div>
                                    			<h5 class="card-text fw-bold">Departure:-<span class="fw-bold fs-3 font5 fontcolor"><%= onefrom %></span></h4>
                                    		</div>
                                    		<div>
                                    			<i class="fas fa-plane"></i>
                                    		</div>
                                    		<div>
                                    			<h5 class="card-text fw-bold">Arrival:-<span class="fw-bold fs-3 font5 fontcolor"><%= oneto %></span></h5>
                                    		</div>
                                		</div>
                                		<div class="text-start py-2">
                                    		<div class="text-start d-md-flex flex-row justify-content-between">
                                        		...
                                        		<p>On Date:-<span class="fw-bold fontcolor2"> <%= onedate %> </span></p>
                                        		<p>Flight Class:- <span class="fw-bold fontcolor2"> <%= flightclass %> </span></h5>

                                    		</div>
                                    	<div class="text-start d-md-flex flex-row justify-content-between">
                                        	<p>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype %></p>
                                        	<p>Flight ID:- <span class="fw-bold fontcolor2"> <%=OW1 %>  </p>
                                        	<p>Price:-<span class="fw-bold fontcolor2"> <%= flight1_price %> /-</p>
                                    	</div>
                                </div>
                                <div class="text-center">
                                    <form action="onewayvalues" method="post">
									    <input type="hidden" name="flightId" value="<%= OW1 %>">
                            ...
                            <div class="card">
                                <div class="card-body text-white font7">
                                	<h6 class="card-title text-center font2">Flight 2</h6>
                                    	...
                                    	<div class="text-start d-md-flex flex-row justify-content-between">
                                        	<p>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype %></p>
                                        	<p>Flight ID:- <span class="fw-bold fontcolor2"> <%=OW2 %>  </p>
                                        	<p>Price:-<span class="fw-bold fontcolor2"> <%= flight2_price %> /-</p>
                                    	</div>
                                </div>
                                <div class="text-center">
                                    <form action="onewayvalues" method="post">
									    <input type="hidden" name="flightId" value="<%= OW2 %>">
                            ...
                            <div class="card">
                                <div class="card-body text-white font7">
                                	<h6 class="card-title text-center font2">Flight 3</h6>
                                    	...
                                    	<div class="text-start d-md-flex flex-row justify-content-between">
                                        	<p>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype %></p>
                                        	<p>Flight ID:- <span class="fw-bold fontcolor2"> <%=OW3 %> </p>
                                        	<p>Price:-<span class="fw-bold fontcolor2"> <%= flight3_price %> /-</p>
                                    	</div>
                                </div>
                                <div class="text-center">
                                    <form action="onewayvalues" method="post">
									    <input type="hidden" name="flightId" value="<%= OW3 %>">
                            ...
                            <div class="card">
                                <div class="card-body text-white font7">
                                	<h6 class="card-title text-center font2">Flight 4</h6>
                                    	...
                                    	<div class="text-start d-md-flex flex-row justify-content-between">
                                        	<p>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype %></p>
                                        	<p>Flight ID:- <span class="fw-bold fontcolor2"> <%=OW4 %>  </p>
                                        	<p>Price:-<span class="fw-bold fontcolor2"> <%= flight4_price %> /-</p>
                                    	</div>
                                </div>
                                <div class="text-center">
                                    <form action="onewayvalues" method="post">
									    <input type="hidden" name="flightId" value="<%= OW4 %>">
