...
<html lang="en">
  ...
  <body>
	...
	double passenger = Double.parseDouble(Returnpassenger);
	...
	double totalprice = ammount2 + taxprice;
 ...
 <div class="container-fluid p-0">
                        ...
                        <form action="payment" method="post">
                            ...
                            <div class="row align-items-center py-md-3">
                                <div class="col-12 text-center py-2">
                                    <p class="fw-bold">A.Flight Origin</p>
                                </div>

                                <div class="col-12 col-md-6 my-2 text-center">
                                    <h6>1.Departure:- <strong><%= Rfrom.toUpperCase() %></strong></h6>
                                </div>
                                
								<div class="col-12 col-md-6 my-2 text-center">
                                    <h6>2.Arrival:- <strong><%= Rto.toUpperCase() %></strong></h6>
                                </div>
                                
                                <div class="col-12 col-md-4 my-2 my-md-3 text-center">
                                    <h6>3.Flight-Time:- <strong><%= time1  %></strong></h6>
                                </div>
                                
                                <div class="col-12 col-md-4 my-2 my-md-3 text-center">
                                    <h6>3.Flight-Date:- <strong><%= Departuredate  %></strong></h6>
                                </div>
                            ...
                            <div class="row align-items-center py-md-3">
                                <div class="col-12 text-center py-2">
                                    <p class="fw-bold">B.Return Flight</p>
                                </div>

                                <div class="col-12 col-md-6 my-2 text-center">
                                    <h6>1.Departure:- <strong><%= Rto.toUpperCase() %></strong></h6>
                                </div>
                                
								<div class="col-12 col-md-6 my-2 text-center">
                                    <h6>2.Arrival:- <strong><%= Rfrom.toUpperCase() %></strong></h6>
                                </div>
                                
                                <div class="col-12 col-md-4 my-2 my-md-3 text-center">
                                    <h6>3.Flight-time:- <strong><%= time2  %></strong></h6>
                                </div>
                                
                                <div class="col-12 col-md-4 my-2 my-md-3 text-center">
                                    <h6>4.Flight-Date:- <strong><%= Returndate %></strong></h6>
                                </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12 text-center py-2">
                                    <p class="fw-bold">C.Flight Details</p>
                                </div>
                                ...
                                <div class="col-12 col-md-3 my-2 my-md-3 text-center">
                                    <h6>2.Number of Passenger:- <strong><%= Returnpassenger  %></strong></h6>
                                </div>
                                
                                <div class="col-12 col-md-3 my-2 my-md-3 text-center">
                                    <h6>3.Flight-ID:- <strong><%= flightId  %></strong></h6>
                                </div>
                                
                                <div class="col-12 col-md-3 my-2 my-md-3 text-center">
                                    <h6>4.Seats Selected:- <strong>  <% 
        ...
        <% } %>  </strong></h6>
                            ...
                            <div class="row align-items-center">
                                <div class="col-12 text-center py-2">
                                    <p class="fw-bold">D.Payment Details</p>
                                </div>
                                ...
                                <div class="col-12 col-md-4 d-lg-flex flex-column justify-content-evenly align-items-center text-center my-2">
                                    ...
                                    <p>(Flight Price * no passenger(<%= Returnpassenger %>) * 5%)
                                </div>

                                <div class="col-12 col-md-4 d-lg-flex flex-column justify-content-evenly align-items-center text-center my-2">
                                    <h6>3.Total Price :<%= totalprice %></h6>
                                    <p>(Flight Price with Tax * no passenger(<%= Returnpassenger %>))</p>
                                </div>
                            </div>
                            ...
                            <div class="row py-3">
                                <div class="col-12 text-center d-flex flex-row justify-content-evenly">
                                    ...
                                    <a href="return.jsp" class="btn butt_on abutton px-3 py-1 ">Make Changes</a>
