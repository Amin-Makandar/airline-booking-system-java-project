...
<html lang="en">
  ...
  <datalist id="airportlist">
    ...
    <datalist id="indianairport">
        <%
        	
        String indianairportFilePath = application.getRealPath("WEB-INF/data/indian-airports.csv");
        try (Scanner scanner = new Scanner(new File(indianairportFilePath))) {
            int lineNo = 0;
            while (scanner.hasNextLine()) {
                String line = scanner.nextLine().trim();
                lineNo++; // Increment line number
  ...
  <div class="container-fluid p-0">
        <section id="explore_india">
            <div class="contianer-fluid">
                                ...
                                <ul class="navbar-nav ms-auto mb-2 fw-bold mb-lg-0">
                                  ...
                                  <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu bg-dark border-0">
                                      <li><a class="dropdown-item text-white font5" href="">Explore India</a></li>
                ...
                <div class="col-12 text-center">
                  <h2 class="fw-bold display-3 text-white word font1">EXPLORE INDIA</h2>
                  <p class="lead text-white word font5">&quot;India will reveal to you the places in your heart that must be purified&quot;</p>
                </div>
              </div><!--end of row1-->
            </div><!--end of header container-fluid-->
        </section><!--end of header section-->
        
        <section id="bookflights-india">
            <div class="container">
              <div class="row">
                <div class="col-12">
                      ...
                      <div class="tab-pane fade show active" id="nav-return" role="tabpanel" aria-labelledby="nav-return-tab" tabindex="0">
                        <form action="return" method="post">
                          	<div class="row d-block d-flex justify-content-center d-lg-none"><!--return in small and medium screen-->
	                            ...
	                            <div class="col-12 col-md-6 my-2 text-center">
	                              <input list = "indianairport" aria-label="To" class="form-control" placeholder="To" name="Rto" required>
	                            </div>
                          ...
                          <div class="row d-none d-lg-block"><!--return in large screen-->
                            ...
                            <form action="return" method="post">
                              <div class="input-group">
                                ...
                                <input list = "indianairport" aria-label="to" class="form-control" placeholder="To" name="Rto" list="indianairportList" required>
                      ...
                      <div class="tab-pane fade" id="nav-oneway" role="tabpanel" aria-labelledby="nav-oneway-tab" tabindex="0">
                        <form action="oneway" method="post">
                          <div class="row d-block d-flex d-lg-none"><!--return in small and medium screen-->
                            ...
                            <div class="col-12 col-md-6 my-2 text-center">
                              <input list = "indianairport" aria-label="To" class="form-control" placeholder="To" name="Oneto" required>
                            </div>
                            <div class="col-12 col-md-6 my-2 text-center">
                      ...
                      <div class="tab-pane fade" id="nav-multicity" role="tabpanel" aria-labelledby="nav-multicity-tab" tabindex="0">
                        <form action="multicity" method="post">
                          <div class="row d-block d-flex d-lg-none"><!--return in small and medium screen-->
                            ...
                            <div class="col-12 col-md-6 my-2 text-center">
                              <input list = "indianairport" aria-label="To" class="form-control" placeholder="To" name="City2" required>
                            </div>
                            <div class="col-12 col-md-6 my-2 text-center">
                          ...
                          <div class="row d-block d-flex d-lg-none"><!--return in small and medium screen-->
                            ...
                            <div class="col-12 col-md-6 my-2 text-center">
                              <input list = "indianairport" aria-label="To" class="form-control" placeholder="To" name="City4" required>
                            </div>
                            <div class="col-12 col-md-6 my-2 text-center">
                              <input type="date" aria-label="Departure" class="form-control" placeholder="Departure" name="M2date" required>
                            </div>
                            <div class="col-12 col-md-6 my-2 text-center">
                            	<input type="text" class="form-control" placeholder="Number of Passenger" name="Multicity2passenger" >
                            </div>
                            <div class="col-12 col-md-6 my-2 text-center">
                          ...
                          <div class="row d-none d-lg-block"><!--return in large screen-->
                            ...
                            <form action="multicity" method="post">
                              <div class="input-group">
                                ...
                                <input list = "indianairport" aria-label="Last name" class="form-control" placeholder="To" name="City2" required>
                          ...
                          <div class="row d-none d-lg-block"><!--return in large screen-->
                            <div class="col-12">
                              <div class="input-group my-2">
                                ...
                                <input list = "indianairport" aria-label="Last name" class="form-control" placeholder="To" name="City4" required>
        ...
        <section id="india">
            <div class="container-fluid">
              <div class="row py-3 py-lg-5">
                <div class="col-12 text-center">
                  <h2 class="fw-bold display-4 word font1">Best Tourist Places</h2>
                </div>
              </div><!--end of row1-->
              <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                  <div class="card-world">
                    <img src="./Images/India/Amritsar.jpg" class="card-img" alt="...">
                    <div class="card-img-overlay d-flex flex-column justify-content-end align-items-center text-white text-center py-3">
                      <h3 class="card-title fw-bold font7">Amritsar</h3>
                      <p class="card-text font3">Economy Starts from INR 128403/-</p>
                      <a href="" class="text-decoration-none butt_on abutton border border-1 px-4 py-1">BooK Now</a>
                    </div>
                  </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                  <div class="card-world">
                    <img src="./Images/India/dudhsagar-waterfall.jpg" class="card-img" alt="...">
                    <div class="card-img-overlay d-flex flex-column justify-content-end align-items-center text-white text-center py-3">
                      <h3 class="card-title fw-bold font7">Dudhsagar-Waterfall</h3>
                      <p class="card-text font3">Economy Starts from INR 128403/-</p>
                      <a href="" class="text-decoration-none butt_on abutton border border-1 px-4 py-1">BooK Now</a>
                    </div>
                  </div>
                ...
                <div class="col-12 col-md-6  my-3">
                  <div class="card-world">
                    <img src="./Images/India/Kullu-Manali.jpg" class="card-img" alt="...">
                    <div class="card-img-overlay d-flex flex-column justify-content-end align-items-center text-white text-center py-3">
                      <h3 class="card-title fw-bold font7">Kullu-Manali</h3>
                      <p class="card-text font3">Economy Starts from INR 128403/-</p>
                      <a href="" class="text-decoration-none butt_on abutton border border-1 px-4 py-1">BooK Now</a>
                    </div>
                  </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                  <div class="card-world">
                    <img src="./Images/India/Goa.jpg" class="card-img" alt="...">
                    <div class="card-img-overlay d-flex flex-column justify-content-end align-items-center text-white text-center py-3">
                      <h3 class="card-title fw-bold font7">GOA</h3>
                      <p class="card-text font3">Economy Starts from INR 128403/-</p>
                      <a href="" class="text-decoration-none butt_on abutton border border-1 px-4 py-1">BooK Now</a>
                    </div>
                  </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                  <div class="card-world">
                    <img src="./Images/India/Ajanta-Caves.jpg" class="card-img" alt="...">
                    <div class="card-img-overlay d-flex flex-column justify-content-end align-items-center text-white text-center py-3">
                      <h3 class="card-title fw-bold font7">Ajanta-Caves</h3>
                      <p class="card-text font3">Economy Starts from INR 128403/-</p>
                      <a href="" class="text-decoration-none butt_on abutton border border-1 px-4 py-1">BooK Now</a>
                    </div>
                  </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                  <div class="card-world">
                    <img src="./Images/India/kerala.webp" class="card-img" alt="...">
                    <div class="card-img-overlay d-flex flex-column justify-content-end align-items-center text-white text-center py-3">
                      <h3 class="card-title fw-bold font7">Kerela</h3>
                      <p class="card-text font3">Economy Starts from INR 128403/-</p>
                      <a href="" class="text-decoration-none butt_on abutton border border-1 px-4 py-1">BooK Now</a>
                    </div>
                  </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 my-3">
                  <div class="card-world">
                    <img src="./Images/India/kutch.jpg" class="card-img" alt="...">
                    <div class="card-img-overlay d-flex flex-column justify-content-end align-items-center text-white text-center py-3">
                      <h3 class="card-title fw-bold font7">Kutch</h3>
                      <p class="card-text font3">Economy Starts from INR 128403/-</p>
                      <a href="" class="text-decoration-none butt_on abutton border border-1 px-4 py-1">BooK Now</a>
                    </div>
                  </div>
            ...
            </div><!--end of india container-fluid-->
        </section><!--end of india section-->
