                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4 py-2">
                                    <p>DEPARTURE</p>
                                    <h4 class="fontcolor2"><%= onefrom %></h4>
                                </div>
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-2">
                                    <h6>GATE-No</h6>
                                    <p class="fontcolor2">NORTH 1</p>
                                </div>
                                
                                <div class="col-12 col-md-2">
                                    <h6>DATE</h6>
                                    <p class="fontcolor2"><%= onedate%></p>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 d-flex flex-row justify-content-center">
                                    <p>DEPARTURE:-</p>
                                    <p class="fontcolor2 fw-bold"><%= onefrom%></p>
                                </div>
                                
                                <div class="col-12 d-flex flex-row justify-content-center">
                                    <p>ARRIVAL:-</p>
                                    <p class="fontcolor2 fw-bold"><%= oneto%></p>
                                </div>
                            </div> 
