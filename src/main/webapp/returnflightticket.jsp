...
<html lang="en">
  <head>
    ...
    <title>Return Flight Ticket</title>
        ...
        <div class="contianer-fluid">
            <div class="row justify-content-center">
                <div class="col-10 text-center p-0 py-5">
                    ...
                    <p class="lead fontcolor2 font5">Thank You for Choosing Qatar Airways!</p>
                </div>
            </div>      
        </div>
        <div class="container">
                ...
                <div class="col-12 col-lg-8 my-2">
                    <div class="card ticket-background px-3">
                        <div class="card-header bg-transparent d-flex flex-row justify-content-between">
                            ...
                            <h6 class="fw-bold fontcolor2 py-2"><%= flightclass %></h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-md-4 py-2">
                                    <p>DEPARTURE</p>
                                    <h4 class="fontcolor2"><%= Rfrom %></h4>
                                </div>
                                ...
                                <div class="col-12 col-md-4 text-end py-2">
                                    <p>ARRIVAL</p>
                                    <h4 class="fontcolor2"><%= Rto %></h4>
                                </div>
                                
                                <div class="col-12 col-md-6 d-flex flex-row  justify-content-center py-2">
                                    <p>Flight-Date :-</p>
                                    <p class="fontcolor2"><%= Departuredate %></p>
                                </div>
                                
                                <div class="col-12 col-md-6 d-flex flex-row justify-content-center  py-2">
                                    <p>Flight-Time :-</p>
                                    <p class="fontcolor2"><%= time1%></p>
                                </div>
                            </div> 
                            ...
                            <div class="row">
                                <div class="col-12 col-md-4 py-2">
                                    <p>DEPARTURE</p>
                                    <h4 class="fontcolor2"><%= Departuredate %></h4>
                                </div>
                                <div class="col-12 col-md-4 d-flex flex-column justify-content-center align-items-center py-2">
                                    <i class="fas fa-plane fontcolor2 fs-2"></i>
                                </div>
                                ...
                                <div class="col-12 col-md-6 d-flex flex-row  justify-content-center py-2">
                                    <p>Flight-Date :-</p>
                                    <p class="fontcolor2"><%= Returndate %></p>
                                </div>
                                
                                <div class="col-12 col-md-6 d-flex flex-row justify-content-center  py-2">
                                    <p>Flight-Time :-</p>
                                    <p class="fontcolor2"><%= time2%></p>
                                </div>
                            ...
                            <div class="row text-center">
                                ...
                                <div class="col-12 col-md-3 py-2">
                                    <p>Flight-Type</p>
                                    <h6 class="fontcolor2"><%= flighttype%></h6>
                                </div>
                                
                                <div class="col-12 col-md-3 py-2">
                                    <p>No Passenger</p>
                                    <h6 class="fontcolor2"><%=  numberofpassenger%></h6>
                                </div>
        ...
        <% } %> </h6>
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <h6>TERMINAL</h6>
                                    <p class="fontcolor2">2S</p>
                                </div>

                                <div class="col-12 col-md-2">
                                    <h6>GATE-No</h6>
                                    <p class="fontcolor2">EAST 2</p>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                            	<div class="col-12 d-flex flex-row justify-content-center">
                                    <p class="fontcolor2">FLIGHT-1</p>    
                                </div>
                                <div class="col-12 d-flex flex-row justify-content-center">
                                    <p>DEPARTURE:-</p>
                                    <p class="fontcolor2 fw-bold"><%= Rfrom%></p>
                                </div>
                                
                                <div class="col-12 d-flex flex-row justify-content-center">
                                    <p>ARRIVAL:-</p>
                                    <p class="fontcolor2 fw-bold"><%= Rto%></p>
                                </div>
                            </div> 
