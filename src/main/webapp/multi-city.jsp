...
<html lang="en">
  ...
  <body>
   ...
   <%
  	...
  	int flight3_price = 0;
  	int flight4_price = 0;
  	if ("Economy Class".equals(flightclass)) {
        Random rand = new Random();
        for (int i = 0; i < 2; i++) {
        	flight1_price = rand.nextInt(40001) + 20000; // Generate random number between 20000 and 60000
        	flight2_price = rand.nextInt(40001) + 20000; // Generate random number between 20000 and 60000
        	//flight3_price = rand.nextInt(40001) + 20000;
        	//flight4_price = rand.nextInt(40001) + 20000;
        }
        
      
    }else if("Business Class".equals(flightclass)){
    	 Random rand = new Random();
         for (int i = 0; i < 2; i++) {
        	 flight1_price = rand.nextInt(40001) + 100000; // Generate random number between 20000 and 60000
         	flight2_price = rand.nextInt(40001) + 100000; // Generate random number between 20000 and 60000
         	//flight3_price = rand.nextInt(40001) + 100000;
        	//flight4_price = rand.nextInt(40001) + 100000;
         }
    	...
    	Random rand = new Random();
        for (int i = 0; i < 2; i++) {
        	flight1_price = rand.nextInt(40001) + 120000; // Generate random number between 20000 and 60000
        	flight2_price = rand.nextInt(40001) + 120000; // Generate random number between 20000 and 60000
        	//flight3_price = rand.nextInt(40001) + 120000;
        	//flight4_price = rand.nextInt(40001) + 120000;
        }
        
    }
  	
  	
  	if ("Economy Class".equals(flightclass2)) {
        Random rand = new Random();
        for (int i = 0; i < 2; i++) {
        	//flight1_price = rand.nextInt(40001) + 20000; // Generate random number between 20000 and 60000
        	//flight2_price = rand.nextInt(40001) + 20000; // Generate random number between 20000 and 60000
    ...
    }else if("Business Class".equals(flightclass2)){
    	 Random rand = new Random();
         for (int i = 0; i < 2; i++) {
        	 //flight1_price = rand.nextInt(40001) + 100000; // Generate random number between 20000 and 60000
         	//flight2_price = rand.nextInt(40001) + 100000; // Generate random number between 20000 and 60000
    ...
    }else if("First Class".equals(flightclass2)){
    	Random rand = new Random();
        for (int i = 0; i < 2; i++) {
        	//flight1_price = rand.nextInt(40001) + 120000; // Generate random number between 20000 and 60000
        	//flight2_price = rand.nextInt(40001) + 120000; // Generate random number between 20000 and 60000
                    ...
                    <div class="row ">
                        <div class="col-12 p-0 my-3">
                            <div class="card">
                                ...
                                <div class="py-2">
                                    <div class="d-md-flex flex-row justify-content-evenly align-items-center py-3">
                                        <h5 class="card-text fw-bold">Departure:-<span class="fw-bold fs-3 font5 fontcolor"><%= city1 %></span></h4>
                                        <i class="fas fa-plane"></i>
                                        <h5 class="card-text fw-bold">Arrival:-<span class="fw-bold fs-3 font5 fontcolor"><%= city2 %></span></h5>
                                    </div>
                                    <div class=" d-md-flex flex-row justify-content-evenly">
                                        <p>Flight Timing:-<span class="fw-bold fontcolor2"> <%= futureTime1%> </span></p>
                                        <p>On Date:-<span class="fw-bold fontcolor2 pe-lg-5"> <%= mdate %> </span></p>    
                                        <p>Flight ID:- <span class="fw-bold fontcolor2"> <%= MC1 %></p>
                                    </div>
                                    <div class="text-start d-md-flex flex-row justify-content-evenly">
                                        <h6>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype %></h6>
                                        <h6>Flight Class:- <span class="fw-bold fontcolor2"> <%= flightclass %> </span></hh6>
                                        <h6>Price:-<span class="fw-bold fontcolor2"><%= flight1_price %></h6>
                                    </div>
                                </div>
                                <div class="py-2">
                                    <div class="d-md-flex flex-row justify-content-evenly align-items-center py-3">
                                        <h5 class="card-text fw-bold">Departure:-<span class="fw-bold fs-3 font5 fontcolor"><%= city3 %></span></h4>
                                        <i class="fas fa-plane"></i>
                                        <h5 class="card-text fw-bold">Arrival:-<span class="fw-bold fs-3 font5 fontcolor"><%= city4 %></span></h5>
                                    </div>
                                    <div class=" d-md-flex flex-row justify-content-evenly">
                                        <p>Flight Timing:-<span class="fw-bold fontcolor2"> <%= futureTime2 %> </span></p>
                                        <p>On Date:-<span class="fw-bold fontcolor2 pe-lg-5"><%= m2date %> </span></p>    
                                        <p>Flight ID:- <span class="fw-bold fontcolor2"> <%= MC2 %></p>
                                    </div>
                                
                                    <div class="text-start d-md-flex flex-row justify-content-evenly ">
                                        <h6>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype %></h6>
                                        <h6>Flight Class:- <span class="fw-bold fontcolor2"> <%= flightclass2 %> </span></hh6>
                                        <h6>Price:-<span class="fw-bold fontcolor2"> <%= flight2_price %>/-</h6>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <form action="multicityvalues" method="post">
									    <input type="hidden" name="flightId1" value="<%= MC1 %>">
									    <input type="hidden" name="flightId2" value="<%= MC2 %>">
									    <input type="hidden" name="flight1_price" value="<%= flight1_price %>">
									    <input type="hidden" name="flight2_price" value="<%= flight2_price %>">
									    <input type="hidden" name="flight1_time" value="<%= futureTime1 %>">
									    <input type="hidden" name="flight2_time" value="<%= futureTime2 %>">
                        ...
                        <div class="col-12 p-0 my-3">
                            <div class="card">
                                <div class="card-body text-white font7">
                                <h6 class="card-title text-center font2">Flight 2</h6>
                                <div class="py-2">
                                    <div class="d-md-flex flex-row justify-content-evenly align-items-center py-3">
                                        <h5 class="card-text fw-bold">Departure:-<span class="fw-bold font5 fs-3 fontcolor"><%= city1 %></span></h4>
                                        <i class="fas fa-plane"></i>
                                        <h5 class="card-text fw-bold">Arrival:-<span class="fw-bold font5 fs-3 fontcolor"> <%= city2 %></span></h5>
                                    </div>
                                    <div class=" d-md-flex flex-row justify-content-evenly">
                                        <p>Flight Timing:-<span class="fw-bold fontcolor2"> <%= futureTime3 %> </span></p>
                                        <p>On Date:-<span class="fw-bold fontcolor2 pe-lg-5"> <%= mdate %> </span></p>    
                                        <p>Flight ID:- <span class="fw-bold fontcolor2"> <%= MC3 %></p>
                                    </div>
                                    <div class="text-start d-md-flex flex-row justify-content-evenly">
                                        <h6>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype %></h6>
                                        <h6>Flight Class:- <span class="fw-bold fontcolor2"> <%= flightclass %> </span></hh6>
                                ...
                                <div class="py-2">
                                    ...
                                    <div class=" d-md-flex flex-row justify-content-evenly">
                                        <p>Flight Timing:-<span class="fw-bold fontcolor2"> <%= futureTime4 %> </span></p>
                                        <p>On Date:-<span class="fw-bold fontcolor2 pe-lg-5"> <%= m2date %> </span></p>    
                                        <p>Flight ID:- <span class="fw-bold fontcolor2"> <%= MC4 %> </p>
                                    </div>
                                
                                    <div class="text-start d-md-flex flex-row justify-content-evenly">
                                        <h6>Flight Type:- <span class="fw-bold fontcolor2"> <%= flighttype %> </h6>
                                        <h6>Flight Class:- <span class="fw-bold fontcolor2"> <%= flightclass2 %> </span></hh6>
                                        <h6>Price:-<span class="fw-bold fontcolor2"><%= flight4_price %>/-</h6>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <form action="multicityvalues" method="post">
									    <input type="hidden" name="flightId1" value="<%= MC3 %>">
									    <input type="hidden" name="flightId2" value="<%= MC4 %>">
									    <input type="hidden" name="flight1_price" value="<%= flight3_price %>">
									    <input type="hidden" name="flight2_price" value="<%= flight4_price %>">
									    <input type="hidden" name="flight1_time" value="<%= futureTime3 %>">
									    <input type="hidden" name="flight2_time" value="<%= futureTime4 %>">
									    <button type="submit" class="btn btn-primary">BOOK NOW</button>
									</form>
                                </div>
                            </div>
